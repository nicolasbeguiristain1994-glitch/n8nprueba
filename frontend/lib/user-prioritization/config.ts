...
export type ValueTier = 'vip' | 'alto' | 'medio' | 'bajo'

export type ReactivationSegment =
  | 'REACTIVACION_URGENTE'          // VIP/ALTO recién inactivos (7–30d) — prob. retorno alta
  | 'REACTIVACION_PRIORITARIA'      // VIP/ALTO 31–90d + MEDIO 14–30d — requieren incentivo
  | 'REACTIVACION_ESTANDAR'         // VIP/ALTO 91–120d + MEDIO 31–60d — oferta especial
  | 'REACTIVACION_FRIA_ALTO_VALOR'  // VIP 121–180d + ALTO 121–150d — win-back de alto LTV
...
export const INACTIVITY_WINDOWS: Record<ValueTier, InactivityWindow> = {
  vip:   { minDays: 7,  maxDays: 180 },  // Extendido: VIP frío incluye hasta 6 meses
  alto:  { minDays: 7,  maxDays: 150 },  // Extendido: ALTO frío hasta 5 meses
...
export const REACTIVATION_SEGMENT_RULES: SegmentRule[] = [
  // ── VIP y ALTO — de más reciente a más antiguo ───────────────────────────
  {
  ...
  {
    // Win-back: VIP hasta 6 meses, ALTO hasta 5 meses.
  ...
  {
    // Solo VIP llega hasta 180 días (6 meses). ALTO termina en 150d.
    segment: 'REACTIVACION_FRIA_ALTO_VALOR',
    tiers:   ['vip'],
    minDays: 151,
    maxDays: 180,
...
export const DEPOSIT_AMOUNT_TIERS: Array<{ minAmount: number; tier: ValueTier }> = [
  { minAmount: 10_000, tier: 'vip'   },
  { minAmount: 3_000,  tier: 'alto'  },
